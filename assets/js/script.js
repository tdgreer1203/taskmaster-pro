...
/*After appending to the li, the li is then appended to the ul lis in a 
dynamic manner. The taskList variable is what will be used to let the program
know what list it should be appended to.*/
